									...
									<li>
										<c:choose>
										 	<c:when test="${!empty condit}">
										 		<a href="${url }?pageNumber=${page.pageNumber - 1 }&condit=${condit }">&lsaquo;&lsaquo;</a>
										 	</c:when>
										 	
										 	<c:otherwise>
										 		<a href="${url }?pageNumber=${page.pageNumber - 1 }">&lsaquo;&lsaquo;</a>
										 	</c:otherwise>
										 </c:choose>
									</li>
								</c:otherwise>
								...
								<c:otherwise>
									<li>
										<c:choose>
										 	...
										 	<c:otherwise>
										 		<a href="${url }?pageNumber=${page.pageNumber + 1 }">&rsaquo;&rsaquo;</a>
										 	</c:otherwise>
										 </c:choose>
									</li>
								</c:otherwise>
