...
public class FillQuestion extends BaseFillQuestion<FillQuestion> {
	 ...
	 */
	public Page<FillQuestion> paginate(int pageNumber, int pageSize, String condit) {
//		StringBuilder selectSql = new StringBuilder();
//		selectSql.append(" select *,if(qall_times = 0,0,(qtrue_times/qall_times)) as true_rate");
		StringBuilder fromSql = new StringBuilder();
		fromSql.append("from fill_question");
		StringBuilder whereSql = new StringBuilder();
		whereSql.append(" where 1 = 1 ");
		if (StrKit.notBlank(condit)) {
			whereSql.append(" and f_question like ").append("'%").append(condit).append("%'");
		}
		StringBuilder orderSql = new StringBuilder();
		orderSql.append(" order by f_id asc");
